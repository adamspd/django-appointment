...
from appointment.views_admin import get_user_appointments, display_appointment, user_profile, update_working_hours, \
    ...
    remove_superuser_staff_member, add_or_update_service, delete_service, remove_staff_member
...
admin_urlpatterns = [
    ...
    path('create-staff-member/', create_new_staff_member, name='create_new_staff_member'),
