...
def get_user_appointments(request, response_type='html'):
    ...
    # if appointment is empty and user doesn't have a staffmember instance, put a message
    if not appointments and not StaffMember.objects.filter(user=request.user).exists():
