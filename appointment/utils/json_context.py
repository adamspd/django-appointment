...
from appointment.utils.date_time import js_timepicker_display_format, js_datepicker_display_format
...
def get_generic_context(request, admin=True):
    ...
    localized_formats = {
        ...
        "js_datepicker_display_format": js_datepicker_display_format()
    }
    return {
